            ...
            <div class="content-dataTable" style="width: 80%; margin: 0 auto; margin-top: -70px; margin-right: 70px">
                ...
                <table id="pacientes" class="display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <td><center><a href="formPaciente.php?id=<?php echo $linha['id_paciente']; ?>">Editar</a></center></td>
                        <td><center><a href="buscarPaciente.php?id_exclusao=<?php echo $linha['id_paciente']; ?>">Excluir</a></td></center>
