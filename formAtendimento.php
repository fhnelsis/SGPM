                ...
                <form method="POST" >
                    <table width="100%">
                            ...
                            <td>
                                <select name="id_tipo_atendimento" id="id_tipo_atendimento" style="margin-top: 5px; ">
                                    ...
                                    <?php while ($linhaAtendimento = mysqli_fetch_array($queryTipos)): ?>
                                        <option <?php if (isset($dadosAtendimento['id_tipo_atendimento']) && $dadosAtendimento['id_tipo_atendimento'] == $linhaAtendimento['id_tipo_atendimento']) : ?> selected <?php endif; ?> value="<?php echo $linhaAtendimento['id_tipo_atendimento']; ?>"><?php echo $linhaAtendimento['nome_tipo_atendimento']; ?></option>
                                    <?php endwhile; ?>
                                </select>
                            ...
                            <td>
                                <select name="id_funcionario" id="id_funcionario" style="margin-top: 5px; ">
                                    ...
                                    <?php while ($linhaFuncionario = mysqli_fetch_array($queryFuncionario)): ?>
                                        <option <?php if (isset($dadosAtendimento['id_funcionario']) && $dadosAtendimento['id_funcionario'] == $linhaFuncionario['id_funcionario']) : ?> selected <?php endif; ?> value="<?php echo $linhaFuncionario['id_funcionario']; ?>"><?php echo $linhaFuncionario['nome_funcionario']; ?></option>
                                    <?php endwhile; ?>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input style="margin-top: 5px; " type="radio" name="fumante" id="f_sim"  value="1" <?php if (isset($dadosAtendimento['fumante']) && $dadosAtendimento['fumante'] == 1) : ?> checked <?php endif; ?> /> Sim <br />
                                <input style="margin-top: 5px; " type="radio" name="fumante" id="f_nao"  value="0" <?php if (isset($dadosAtendimento['fumante']) && $dadosAtendimento['fumante'] == 0) : ?> checked <?php endif; ?> /> Não <br />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input style="margin-top: 5px" type="radio" name="alcool" id="a_sim"  value="1" <?php if (isset($dadosAtendimento['alcool']) && $dadosAtendimento['alcool'] == 1) : ?> checked <?php endif; ?> /> Sim <br />
                                <input style="margin-top: 5px" type="radio" name="alcool" id="a_nao"  value="0" <?php if (isset($dadosAtendimento['alcool']) && $dadosAtendimento['alcool'] == 0) : ?> checked <?php endif; ?> /> Não <br />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input style="width: 400px; margin-top: 5px; " type="text" name="alergia_reac_div" id="alergia_reac_div" maxlength="50" value="<?php echo isset($dadosAtendimento['alergia_reac_div']) ? $dadosAtendimento['alergia_reac_div'] : ""; ?>" /></td>
                        </tr>

                        <!-- Sintomas -->
                        <tr>
                            <td><label for="sintomas">Sintomas:</label></td>
                            <td><input style="width: 400px; margin-top: 5px; " type="text" name="sintomas" id="sintomas" maxlength="30" value="<?php echo isset($dadosAtendimento['sintomas']) ? $dadosAtendimento['sintomas'] : ""; ?>" /></td>
                        </tr>

                        <!-- Queixa Principal -->
                        <tr>
                            <td><label for="queixa_principal">Queixa Principal:</label></td>
                            <td><input style="width: 400px; margin-top: 5px; " type="text" name="queixa_principal" id="queixa_principal" maxlength="30" value="<?php echo isset($dadosAtendimento['queixa_principal']) ? $dadosAtendimento['queixa_principal'] : ""; ?>" /></td>
                        </tr>

                        <!-- Histórico Molestia -->
                        <tr>
                            <td><label for="hist_molestia">Histórico Molestia:</label></td>
                            <td><input style="width: 400px; margin-top: 5px; " type="text" name="hist_molestia" id="hist_molestia" maxlength="100" value="<?php echo isset($dadosAtendimento['hist_molestia']) ? $dadosAtendimento['hist_molestia'] : ""; ?>" /></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input style="width: 400px; margin-top: 5px; " type="text" name="frequencia_cardiaca" id="frequencia_cardiaca" maxlength="10" value="<?php echo isset($dadosAtendimento['frequencia_cardiaca']) ? $dadosAtendimento['frequencia_cardiaca'] : ""; ?>" /></td>
                        </tr>

                        <!-- Ritmo Cardiaco --> 
                        <tr>
                            <td><label for="ritmo_cardiaco">Ritmo Cardíaca:</label></td>
                            <td><input style="width: 400px; margin-top: 5px; " type="text" name="ritmo_cardiaco" id="ritmo_cardiaco" maxlength="10" value="<?php echo isset($dadosAtendimento['ritmo_cardiaco']) ? $dadosAtendimento['ritmo_cardiaco'] : ""; ?>" /></td>
                        </tr>

                        <!-- Pressão Arterial --> 
                        <tr>
                            <td><label for="pressao_arterial">Pressão Arterial:</label></td>
                            <td><input style="width: 400px; margin-top: 5px; " type="text" name="pressao_arterial" id="pressao_arterial" maxlength="10" value="<?php echo isset($dadosAtendimento['pressao_arterial']) ? $dadosAtendimento['pressao_arterial'] : ""; ?>" /></td>
                        </tr>

                        <!-- Ritmo Respiratório --> 
                        <tr>
                            <td><label for="ritmo_respiratorio">Ritmo Respiratório:</label></td>
                            <td><input style="width: 400px; margin-top: 5px; " type="text" name="ritmo_respiratorio" id="ritmo_respiratorio" maxlength="10" value="<?php echo isset($dadosAtendimento['ritmo_respiratorio']) ? $dadosAtendimento['ritmo_respiratorio'] : ""; ?>" /></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td >
                                <textarea  cols="50" maxlength="300" name="observacoes" id="observacoes" style="height: 100px; margin-top: 10px;  ">
